class AlternativesController < ApplicationController
  ...
  def create
    ...
    @alternative = @issue.alternatives.create(params[:alternative])
  ...
  def destroy
    ...
    @issue = Issue.find(params[:issue_id])
    @alternative = @issue.alternatives.find(params[:id])
    @alternative.destroy
    redirect_to issue_path(@issue)
  ...
  private
    ...
    def alternative_params
      params.require(:alternative).permit(:description, :correct, :issue_id)
    end
end
