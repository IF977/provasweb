...
class QuestsControllerTest < ActionController::TestCase
  ...
  test "should create quest" do
    assert_difference('Quest.count') do
      post :create, quest: { discipline_id: @quest.discipline_id, level: @quest.level, question: @quest.question, subject_id: @quest.subject_id, teacher_id: @quest.teacher_id }
    end
  ...
  test "should update quest" do
    patch :update, id: @quest, quest: { discipline_id: @quest.discipline_id, level: @quest.level, question: @quest.question, subject_id: @quest.subject_id, teacher_id: @quest.teacher_id }
    assert_redirected_to quest_path(assigns(:quest))
  end
